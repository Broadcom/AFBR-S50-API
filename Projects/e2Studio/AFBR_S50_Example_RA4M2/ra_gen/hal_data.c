...
const flash_cfg_t g_flash0_cfg = { .data_flash_bgo = true, .p_callback =
		rm_vee_flash_callback, .p_context = &g_vee0_ctrl,
...
const rm_vee_cfg_t g_vee0_cfg = { .start_addr =
		...
		BSP_DATA_FLASH_SIZE_BYTES, .ref_data_size = 0, .record_max_id = 4,
		.rec_offset = &g_vee0_record_offset[0], .p_callback = Flash_callback,
...
const usb_cfg_t g_basic0_cfg = { .usb_mode = USB_MODE_PERI, .usb_speed =
		USB_SPEED_FS, .module_number = 0, .type = USB_CLASS_PVND,
#if defined(g_usb_descriptor)
...
can_bit_timing_cfg_t g_can0_bit_timing_cfg =
		{
				/* Actual bitrate: 1000000 Hz. Actual Bit Time Ratio: 70 %. */.baud_rate_prescaler =
						1 + 4 /* Division value of baud rate prescaler */,
				.time_segment_1 = 6, .time_segment_2 = 3,
...
const can_cfg_t g_can0_cfg = { .channel = 0, .p_bit_timing =
		...
		&g_can0_extended_cfg, .p_context = NULL, .ipl = (3),
...
const timer_cfg_t g_upt_cfg = { .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.0001 seconds. Actual duty: 50%. */.period_counts =
		(uint32_t) 0x2710, .duty_cycle_counts = 0x1388, .source_div =
		(timer_source_div_t) 0, .channel = 2, .p_callback = usb_poll_callback,
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = &NULL,
#endif
		.p_extend = &g_upt_extend, .cycle_end_ipl = (4),
...
/* Instance structure to use this module. */
const timer_instance_t g_upt = { .p_ctrl = &g_upt_ctrl, .p_cfg = &g_upt_cfg,
...
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts =
    ...
    .p_context           = NULL,
		...
		.p_context = &NULL,
#endif
		.p_extend = &g_pit_extend, .cycle_end_ipl = (2),
...
/* Instance structure to use this module. */
const timer_instance_t g_pit = { .p_ctrl = &g_pit_ctrl, .p_cfg = &g_pit_cfg,
		.p_api = &g_timer_on_gpt };
...
const timer_cfg_t g_ltc_cfg = { .mode = TIMER_MODE_PERIODIC,
/* Actual period: 4000 seconds. Actual duty: 50%. */.period_counts =
		(uint32_t) 0x5d21dba0, .duty_cycle_counts = 0x2e90edd0, .source_div =
		(timer_source_div_t) 8, .channel = 0, .p_callback = NULL,
/** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
		.p_context = &NULL,
#endif
		.p_extend = &g_ltc_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_ltc = { .p_ctrl = &g_ltc_ctrl, .p_cfg = &g_ltc_cfg,
		.p_api = &g_timer_on_gpt };
...
#endif
#undef RA_NOT_DEFINED
		.rxi_ipl = (1), .txi_ipl = (1), .tei_ipl = (1), .eri_ipl = (1),
...
const spi_extended_cfg_t g_spi0_ext_cfg = { .spi_clksyn = SPI_SSL_MODE_CLK_SYN,
		...
		.ssl_select = SPI_SSL_SELECT_SSL0, .mosi_idle =
				SPI_MOSI_IDLE_VALUE_FIXING_HIGH, .parity =
...
const spi_cfg_t g_spi0_cfg = { .channel = 0,
    ...
    .eri_irq             = VECTOR_NUMBER_SPI0_ERI,
		...
		.p_transfer_rx = g_spi0_P_TRANSFER_RX, .p_callback = user_spi_callback,
