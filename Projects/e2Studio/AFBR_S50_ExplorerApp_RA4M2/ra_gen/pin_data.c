...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = { { .pin = BSP_IO_PORT_00_PIN_00,
		...
		| (uint32_t) IOPORT_PERIPHERAL_SCI0_2_4_6_8) }, { .pin =
		BSP_IO_PORT_01_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
		| (uint32_t) IOPORT_PERIPHERAL_CAN) }, { .pin = BSP_IO_PORT_01_PIN_04,
		...
		| (uint32_t) IOPORT_PERIPHERAL_SPI) }, { .pin = BSP_IO_PORT_01_PIN_11,
		.pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
				| (uint32_t) IOPORT_PERIPHERAL_SPI) }, { .pin =
